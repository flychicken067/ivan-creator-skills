...
mkdir -p "$dist_dir"
rm -f "$dist_dir/ivan-human-ui.zip" "$dist_dir/ivan-skill-value-cover.zip" "$dist_dir/sun-study-female-reversal.zip"
...
printf '%s\n' "$dist_dir/ivan-human-ui.zip" "$dist_dir/ivan-skill-value-cover.zip" "$dist_dir/sun-study-female-reversal.zip"
